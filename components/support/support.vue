<template>
  ...
  >
    ...
    <p>
      ...
      <a
        :style="gitHubIcon"
        class="support__external-link support__iconography-github"
...
import VendorLogo from '~/assets/sponsors/jetbrains-logo.png?data'

@Component
class SupportPage extends Vue {
  get gitHubIcon () {
    const width = '10px'
    const height = '10px'
