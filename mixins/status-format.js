...
export default {
  methods: {
    filterStatuses (statuses, filterType) {
    ...
    formatStatuses (statuses) {
      ...
      if (typeof statuses.forEach !== 'function') {
        throw new TypeError(this.errorMessages.REQUIRED_COLLECTION)
      }
    ...
    sortByPublicationDate (statusA, statusB) {
